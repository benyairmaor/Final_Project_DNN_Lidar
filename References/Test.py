...
def preprocess_point_cloud(pcd, voxel_size):
    ...
    pcd_fpfh = o3d.pipelines.registration.compute_fpfh_feature(
        pcd, o3d.geometry.KDTreeSearchParamHybrid(radius=radius_feature, max_nn=500))
...
if __name__ == '__main__':
    ...
    source_arr = np.asarray(source_fpfh.data).T[indexArrS]
    ...
    target_arr = np.asarray(target_fpfh.data).T[indexArrT]
    ...
    source_arr = np.asarray(key_source.points)
    target_arr = np.asarray(key_target.points)
